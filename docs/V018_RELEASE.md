...
- The npm workflow contract normalizes workflow line endings before multiline checks, so the same reviewed manifest-driven workflow passes on Windows CRLF and Linux LF checkouts.
