...
for(const marker of ["embuilder build zlib libjpeg","-fwasm-exceptions","REQUIRE_CRYPTO_NATIVE=ON","USE_IMPLICIT_CRYPTO=OFF","qpdf-core.wasm"]) need(build.includes(marker),"QPDF build missing contract marker: "+marker);
